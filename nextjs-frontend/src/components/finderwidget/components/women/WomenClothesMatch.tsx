...
export const WomenClothesMatch: React.FC = () => {
    ...
    const handleRedirect = (e: React.FormEvent) => {
        ...
        window.location.href = `http://magentodemo247.co.uk/women/tops-women.html${getOptionQuery(optionState.optionSelection)}`
    }
